...
* **Http-server**: is a simple, zero-configuration command-line http server. It is powerful enough for production usage, but it\'s simple and hackable enough to be used for testing, local development, and wedding-planner-backending.
...
```javascript
var fs = require("fs");
var data = 'Simply Easy wedding-planner-backending';
